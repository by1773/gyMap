<template>
  <Layout style="height: 100%"
    ...
    <Sider hide-trigger
           ...
           :collapsed-width="64"
           v-model="collapsed"
           :class="{ 'left-sider':true,'bigScreen': bigScreen==true}"
    ...
    <Layout>
      ...
      <Content class="main-content-con">
        <Layout class="main-layout-con">
          ...
          <Content :class="{ 'content-wrapper':true,'bigScreenMain': bigScreen==true}">
...
import { ajaxFun } from '../../libs/commonFn'
import './main.less'
export default {
  name: 'Main',
  components: {
  ...
  computed: {
    ...
    userAvator () {
      ...
      const gender = this.$store.state.user.gender
      if (gender === '男') {
